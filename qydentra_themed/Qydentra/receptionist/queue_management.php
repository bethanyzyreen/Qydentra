...
<input type="hidden" name="queue_status" id="qs_<?php echo $row['id']; ?>" value="">

<button type="button"
class="queue-status-btn waiting <?php echo $row['status']=='Approved'?'active-status':''; ?>"
<?php echo $row['status']=='Approved'?'disabled':''; ?>
onclick="submitQueueStatus(<?php echo $row['id']; ?>, 'Approved', this)">
...
onclick="submitQueueStatus(<?php echo $row['id']; ?>, 'In Progress', this)">
...
onclick="submitQueueStatus(<?php echo $row['id']; ?>, 'Completed', this)">
